...
int main(int argc, char **argv){
    ...
    double erreur_infty;
    // Fichiers
    nom_fichier_bin = "Textes/sequentiel-2/resultats.bin";
    const char *entete;
    double resultats[8];
    ...
    // ======================================================
    printf("------------------------------------------------------------\n");
    printf("Exécution séquentielle de : sequentiel-2 (version 4 - schéma implicite - séquentiel)\n");
    cholmod_start(&c);
    ...
    resultats[0] = 4.0; resultats[1] = NAN; resultats[2] = (double)N; resultats[3] = h; resultats[4] = (double)N_t; resultats[5] = h_t; resultats[6] = erreur_infty, resultats[7] = temps;
